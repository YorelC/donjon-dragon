...
| Choix d'origine | Langues, taille d'espèce, dons et outils validés | Deux langues standards exigées, taille bornée à `sizeOptions`, outils concrets et dons d'Origines validés par le serveur | Règles métier couvertes |
