...
| B01-ESP-002 | PHB24 p. 186 | Au niveau 1, l'Aasimar reçoit la catégorie P ou M déduite de sa taille physique (B01-ESP-012), puis Résistance céleste, Vision dans le noir, Mains guérisseuses et Porteur de lumière, sans choix interne de Révélation céleste. Cette dernière n'arrive qu'au niveau 3 et son option est choisie à chaque activation. | Clé absente du contrat, du domaine, des données locales et de l'interface. **Manquant**. | Créateur ; espèce Aasimar, taille. | Un Aasimar niveau 1 valide reçoit sa catégorie calculée et peut être soumis sans choix prématuré de Révélation céleste ; sa fiche justifie ses quatre traits de niveau 1. | Révélation céleste relève de B02 ; SF-002. |
