...
| SF-002 | Personnages | [REQUIREMENTS](REQUIREMENTS.md#sf-002--création-validation-et-évolution-dun-personnage), [attribution, vivier et visibilité](../specs/007-character-assignment-visibility.md), [création serveur du niveau 1](../specs/009-level-one-character-creation.md) | [DEC-003](DECISIONS/003-character-lifecycle.md), [DEC-008](DECISIONS/008-level-one-character-details.md), [DEC-009](DECISIONS/009-adventure-state-and-corrections.md), [DEC-011](DECISIONS/011-spells-and-magical-effects.md), [DEC-012](DECISIONS/012-equipment-items-and-possessions.md), [DEC-014](DECISIONS/014-game-surrounding-product-rules.md), [DEC-017](DECISIONS/017-executable-versioned-rule-model.md) | `VÉRIFIÉ` pour Specs 007 et 009 : auto-attribution, remplacement atomique, projections privées, création niveau 1 autoritaire et parcours wizard. La validation MJ et l'édition des données personnelles après acceptation sont implémentées ; leur nouvelle preuve Mongo est écrite mais reste à exécuter sur une réplica-set disponible. Portrait et progression restent hors de ces incréments |
...
|---|---|---|---:|---|---|
| B01 | Création complète niveau 1 | [Matrice B01](rules/dnd-2024/B01-LEVEL-ONE-CREATION.md), [Spec 009](../specs/009-level-one-character-creation.md) | 85 | DR-B01-01 à DR-B01-04 résolues ; DEC-003 et DEC-008 | `PARTIEL` — 74 conformes, 10 partielles et 1 absente en validation domaine. Le workflow de revue est couvert en unité et HTTP ; sa preuve Mongo réelle doit être rejouée. Bilan détaillé dans la Spec 009 |
