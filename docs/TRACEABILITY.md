...
|---|---|---|---:|---|---|
| B01 | Création complète niveau 1 | [Matrice B01](rules/dnd-2024/B01-LEVEL-ONE-CREATION.md), [Spec 009](../specs/009-level-one-character-creation.md) | 85 | DR-B01-01 à DR-B01-04 résolues ; DEC-003 et DEC-008 | `PARTIEL` — 72 conformes, 8 partielles, 5 absentes en validation domaine ; parcours front incomplet. Bilan détaillé dans la Spec 009 |
