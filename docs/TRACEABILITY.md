...
|---|---|---|---|---|
| SF-001 | Campagnes, rôles, amitiés et permissions | [REQUIREMENTS](REQUIREMENTS.md#sf-001--campagnes-rôles-et-permissions), [incrément création atomique](../specs/004-campaign-foundation.md) | [DEC-002](DECISIONS/002-roles-and-visibility.md), [DEC-013](DECISIONS/013-monsters-npcs-and-summoned-creatures.md), [DEC-016](DECISIONS/016-target-mongodb-persistence.md) | Premier incrément backend implémenté pour la création idempotente, la racine et les adhésions séparées, l'enveloppe reçue–audit–outbox et la lecture masquée ; purge, succession et invitations cibles restent à implémenter |
| SF-002 | Personnages | [REQUIREMENTS](REQUIREMENTS.md#sf-002--création-validation-et-évolution-dun-personnage) | [DEC-003](DECISIONS/003-character-lifecycle.md), [DEC-008](DECISIONS/008-level-one-character-details.md), [DEC-009](DECISIONS/009-adventure-state-and-corrections.md), [DEC-011](DECISIONS/011-spells-and-magical-effects.md), [DEC-012](DECISIONS/012-equipment-items-and-possessions.md), [DEC-014](DECISIONS/014-game-surrounding-product-rules.md), [DEC-017](DECISIONS/017-executable-versioned-rule-model.md) | Création, progression, multiclassage/respécialisation, état d'aventure, sorts et possessions spécifiés ; principes moteur 5C validés, détails provisoires ; implémentation partielle |
