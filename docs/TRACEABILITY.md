...
|---|---|---|---|---|
| SF-001 | Campagnes, rôles, amitiés et permissions | [REQUIREMENTS](REQUIREMENTS.md#sf-001--campagnes-rôles-et-permissions), [incrément création atomique](../specs/004-campaign-foundation.md), [cycle d'invitation](../specs/005-campaign-invitation-lifecycle.md) | [DEC-002](DECISIONS/002-roles-and-visibility.md), [DEC-013](DECISIONS/013-monsters-npcs-and-summoned-creatures.md), [DEC-016](DECISIONS/016-target-mongodb-persistence.md) | `VÉRIFIÉ` pour la création et le cycle d'invitation atomiques : racine, adhésions actives et invitations séparées, idempotence, enveloppe reçue–audit–outbox, autorisations et lectures masquées ; purge et succession restent à implémenter |
