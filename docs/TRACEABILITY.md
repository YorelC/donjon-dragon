...
|---|---|---|---|---|
| SF-001 | Campagnes, rôles, amitiés et permissions | [REQUIREMENTS](REQUIREMENTS.md#sf-001--campagnes-rôles-et-permissions), [incrément création atomique](../specs/004-campaign-foundation.md), [cycle d'invitation](../specs/005-campaign-invitation-lifecycle.md), [cycle des rôles, propriété et départ](../specs/006-campaign-role-ownership-lifecycle.md) | [DEC-002](DECISIONS/002-roles-and-visibility.md), [DEC-013](DECISIONS/013-monsters-npcs-and-summoned-creatures.md), [DEC-016](DECISIONS/016-target-mongodb-persistence.md) | `VÉRIFIÉ` pour la création, les invitations et la Spec 006 : contrat HTTP, rôles, propriété, départ, exclusion, désassignations, enveloppes et preuves Mongo/Bruno ; seule la succession de purge reste non décidée |
