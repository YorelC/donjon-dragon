...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center p-[3px] text-ink-idle group-data-[orientation=horizontal]/tabs:h-10 group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "border border-gold/14 bg-surface",
        line: "gap-1 bg-transparent",
        box: "flex-wrap gap-2 bg-transparent p-0 group-data-[orientation=horizontal]/tabs:h-auto",
        panel:
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=box]/tabs-list:h-auto group-data-[variant=box]/tabs-list:flex-none group-data-[variant=box]/tabs-list:px-[18px] group-data-[variant=box]/tabs-list:py-2.5 group-data-[variant=box]/tabs-list:data-[state=inactive]:border-gold/20 group-data-[variant=box]/tabs-list:data-[state=inactive]:text-gold/85",
