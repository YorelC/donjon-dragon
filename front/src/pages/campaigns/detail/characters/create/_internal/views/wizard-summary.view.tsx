...
import { backgroundOf, classOf, speciesOf } from "../types/wizard-lookups";

interface WizardSummaryViewProps {
  catalog: DndCatalog;
  draft: WizardDraft;
 ...
 */
export function WizardSummaryView(props: WizardSummaryViewProps) {
  return (
...
function Identity({ catalog, draft, characterName }: WizardSummaryViewProps) {
...
function Abilities({ preview, draft }: WizardSummaryViewProps) {
  return (
...
function Proficiencies({ catalog, draft, preview }: WizardSummaryViewProps) {
