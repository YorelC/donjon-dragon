      ...
      options: [
        {
          ...
          entries: [
            { itemKey: 'calligraphers-supplies', quantity: 1 },
            { itemKey: 'book', quantity: 1 },
            { itemKey: 'holy-symbol', quantity: 1 },
            { itemKey: 'parchment', quantity: 10 },
      ...
      options: [
        {
          ...
          entries: [
            { itemKey: 'pouch', quantity: 2 },
            { itemKey: 'clothes-travelers', quantity: 1 },
          ],
          gold: 32,
        },
        GOLD_OPTION,
      ...
      options: [
        {
          ...
          entries: [
            { itemKey: 'forgery-kit', quantity: 1 },
            { itemKey: 'costume', quantity: 1 },
            { itemKey: 'clothes-fine', quantity: 1 },
          ],
          gold: 15,
        },
        GOLD_OPTION,
      ...
      options: [
        {
          ...
          entries: [
            ...
            { itemKey: 'mirror', quantity: 1 },
            { itemKey: 'perfume', quantity: 1 },
            { itemKey: 'clothes-travelers', quantity: 1 },
          ],
          gold: 11,
        },
      ...
      options: [
        {
          ...
          entries: [
            ...
            { itemKey: 'carpenters-tools', quantity: 1 },
            { itemKey: 'healers-kit', quantity: 1 },
            { itemKey: 'pot-iron', quantity: 1 },
            { itemKey: 'shovel', quantity: 1 },
            { itemKey: 'clothes-travelers', quantity: 1 },
          ],
          gold: 30,
        },
      ...
      options: [
        {
          ...
          entries: [
            ...
            { itemKey: 'lantern-hooded', quantity: 1 },
            { itemKey: 'manacles', quantity: 1 },
      ...
      options: [
        {
          ...
          entries: [
            ...
            { itemKey: 'ammunition', quantity: 20 },
            { itemKey: 'cartographer-tools', quantity: 1 },
            { itemKey: 'bedroll', quantity: 1 },
            { itemKey: 'quiver', quantity: 1 },
            { itemKey: 'tent', quantity: 1 },
            { itemKey: 'clothes-travelers', quantity: 1 },
          ],
          gold: 3,
        },
      ...
      options: [
        {
          ...
          entries: [
            ...
            { itemKey: 'bedroll', quantity: 1 },
            { itemKey: 'book', quantity: 1 },
            { itemKey: 'lamp', quantity: 1 },
            { itemKey: 'oil', quantity: 3 },
            { itemKey: 'clothes-travelers', quantity: 1 },
          ],
          gold: 16,
        },
      ...
      options: [
        {
          ...
          entries: [
            { itemKey: 'navigators-tools', quantity: 1 },
            { itemKey: 'pouch', quantity: 2 },
            { itemKey: 'clothes-travelers', quantity: 1 },
          ],
          gold: 22,
